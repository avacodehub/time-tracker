...
export default function NewWatch() {
  ...
  const isVisible = useStore((state) => state.isVisible_NewWatch);
  const setIsVisible = useStore((state) => state.setIsVisible_NewWatch);
          ...
          <div className="overlay-content">
            ...
            <Formik
              ...
              onSubmit={(values, { setSubmitting }) => {
                addWatch(values.name, values.customId);
